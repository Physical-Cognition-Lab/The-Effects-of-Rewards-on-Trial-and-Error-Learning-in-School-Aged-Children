...
SR = Time%>%
  ...
  theme(legend.position = "none",
        axis.title.x = element_blank(), axis.line = element_blank(),         axis.text.x = element_text(hjust = 0.5))
...
NumberTool = Ntools%>%
  ...
  scale_x_discrete(label = c('Positive\nreward group','Negative\nreward group','Control'))+
  labs(y = "# of tools")+
  coord_cartesian(xlim = c(1.13, 2.9), ylim = c(0.5,3.7))+
  theme_classic(base_size = 40)+
  theme(legend.position = "none",
        axis.title.x = element_blank(), axis.line = element_blank(),
        axis.text.x = element_text(hjust = 0.5))
...
ggsave(filename = '..\\..\\Results\\Plot\\FinalPlotAnova.svg', FIN,
       width = 23*1.5, height = 11.7*1.5, units = "in", dpi = 300)
ggsave('..\\..\\Results\\Plot\\FinalPlotAnova.jpg', FIN,
       width = 23*1.5, height = 11.7*1.5, units = "in", dpi = 300)
ggsave('..\\..\\Results\\Plot\\FinalPlotAnova.tiff', FIN,
       width = 23*1.5, height = 11.7*1.5, units = "in", dpi = 300)
