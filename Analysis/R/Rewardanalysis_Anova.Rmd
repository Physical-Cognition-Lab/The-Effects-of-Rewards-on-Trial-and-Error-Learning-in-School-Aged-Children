...
In this analysis we run multiple anovas variables and group.
After running the anova we perform a Tukey HSD test to check for significant differences between groups.
...
Time = read_sav(paste(input, 'DatabaseSRATTTIME.sav', sep=''))
